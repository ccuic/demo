...
public class I54sendSms {
    ...
    public void f4() throws IOException {
        String number = "{\"param\":{\"businessLine\":\"haohuan\",\"mobile\":\"14587385111\",\"type\":\"email\"},\"appid\":\"kg1u9xn5gdrtolf1\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
    ...
    public void f5() throws IOException {
        String number = "{\"param\":{\"businessLine\":\"haohuan\",\"mobile\":\"14587385111\",\"type\":\"email\"},\"appid\":\"\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
    ...
    public void f7() throws IOException {
        String number = "{\"param\":{\"businessLine\":\"\",\"mobile\":\"14587385111\",\"type\":\"email\"},\"appid\":\"kg1u9xn5gdrtolfq\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
    ...
    public void f8() throws IOException {
        String number = "{\"param\":{\"mobile\":\"14587385111\",\"type\":\"email\"},\"appid\":\"kg1u9xn5gdrtolfq\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
    ...
    public void f9() throws IOException {
        String number = "{\"param\":{\"businessLine\":\"haohuan2\",\"mobile\":\"14587385111\",\"type\":\"email\"},\"appid\":\"kg1u9xn5gdrtolfq\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
    ...
    public void f10() throws IOException {
        String number = "{\"param\":{\"businessLine\":\"haohuan\",\"mobile\":\"14587385111aa\",\"type\":\"email\"},\"appid\":\"kg1u9xn5gdrtolfq\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
    ...
    public void f11() throws IOException {
        String number = "{\"param\":{\"businessLine\":\"haohuan\",\"mobile\":\"\",\"type\":\"email\"},\"appid\":\"kg1u9xn5gdrtolfq\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
    ...
    public void f12() throws IOException {
        String number = "{\"param\":{\"businessLine\":\"haohuan\",\"type\":\"email\"},\"appid\":\"kg1u9xn5gdrtolfq\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
    }
    @Test// type非法  正确为 email
    public void f13() throws IOException {
        String number = "{\"param\":{\"businessLine\":\"haohuan\",\"mobile\":\"14587385111aa\",\"type\":\"email2\"},\"appid\":\"kg1u9xn5gdrtolfq\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
    ...
    public void f14() throws IOException {
        String number = "{\"param\":{\"businessLine\":\"haohuan\",\"mobile\":\"\",\"type\":\"\"},\"appid\":\"kg1u9xn5gdrtolfq\",\"sign\":\"6af9ced89dde03633d2d20d79c734a04\"}\n";
        String result = IVRUtils.gongyong(url,number);
        if(result.contains("success"))
        {Assert.assertEquals(1,1);}
        else {Assert.assertEquals(0,1);}
