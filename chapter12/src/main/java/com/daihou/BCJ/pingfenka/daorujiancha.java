...
public class daorujiancha {
	private String url;
	Map<String, String> headers;
	@BeforeTest(groups = "loginTrue",description = "测试准备工作,获取Authorization对象")
	public void beforeTest() throws IOException {
		url=DHConfigFile.getUrl(In_Pingfenka.DAORUJIANCHA.toString());
		headers=new HashMap<>();
	...
	public void s1() throws IOException {
		String strBody = "{\"list\":[{\"cellStyleMap\":{},\"stage\":\"S1\",\"orgCode\":\"5NCD1to7\",\"profession\":100,\"complaint\":66,\"internalControls\":76,\"operation\":86,\"strategy\":96,\"labour\":30,\"test\":100,\"importable\":true,\"errorTips\":\"\"}]}";
